# Generated by Django 5.1.3 on 2024-11-21 23:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('certificate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.deliverycertificate')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('equipment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.equipment')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.useraccount')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            name='RentalRequestHistory',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('pending', 'Pending'), ('approved', 'Approved'), ('rejected', 'Rejected')], max_length=20)),
                ('change_date', models.DateTimeField(auto_now_add=True)),
                ('notes', models.TextField(blank=True, null=True)),
                ('rental_request', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.rentalrequest')),
            ],
            options={
